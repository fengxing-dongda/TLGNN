...
parser.add_argument('--save', type=str, default='model/electricity.pt',
...
parser.add_argument('--save_file', type=str, default='./results/electricityL10node_k60result12.txt', help='')
